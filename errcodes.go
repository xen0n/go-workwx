...
const (
	// 文档爬取时间: 2020-03-14 13:01:54 +0800
	//
	// NOTE: 关于错误码的名字为何如此无聊:
	//
	...
	ErrCodeServiceUnavailable ErrCode = -1
	// ErrCodeSuccess 请求成功
	//
	// 排查方法: 接口调用成功
	...
	ErrCode40032 ErrCode = 40032
	// ErrCode40033 不合法的请求字符
	//
	// 排查方法: 不能包含\uxxxx格式的字符
	ErrCode40033 ErrCode = 40033
	// ErrCode40035 不合法的参数
	//
	...
	ErrCode40035 ErrCode = 40035
	// ErrCode40039 不合法的url长度
	//
	// 排查方法: url长度限制1024个字节
	ErrCode40039 ErrCode = 40039
	// ErrCode40050 chatid不存在
	//
	// 排查方法: 会话需要先创建后，才可修改会话详情或者发起聊天
	ErrCode40050 ErrCode = 40050
	...
	ErrCode40082 ErrCode = 40082
	// ErrCode40083 不合法的suite_id
	//
	// 排查方法: suite_id不存在
	ErrCode40083 ErrCode = 40083
	...
	ErrCode41019 ErrCode = 41019
	// ErrCode41017 缺少tagid参数
	//
	// 排查方法: -
	ErrCode41017 ErrCode = 41017
	// ErrCode41021 缺少suite_id参数
	//
	// 排查方法: -
	ErrCode41021 ErrCode = 41021
	// ErrCode41022 缺少suite_access_token参数
	//
	// 排查方法: -
	ErrCode41022 ErrCode = 41022
	// ErrCode41023 缺少suite_ticket参数
	//
	// 排查方法: -
	ErrCode41023 ErrCode = 41023
	// ErrCode41024 缺少secret参数
	//
	// 排查方法: -
	ErrCode41024 ErrCode = 41024
	// ErrCode41025 缺少permanent_code参数
	//
	// 排查方法: -
	ErrCode41025 ErrCode = 41025
	...
	ErrCode45029 ErrCode = 45029
	// ErrCode45032 图文消息author参数长度超过限制
	//
	// 排查方法: 最长64个字节
	ErrCode45032 ErrCode = 45032
	...
	//
	ErrCode45033 ErrCode = 45033
	// ErrCode46003 菜单未设置
	//
	// 排查方法: 菜单需发布后才能获取到数据
	ErrCode46003 ErrCode = 46003
	// ErrCode46004 指定的用户不存在
	//
	// 排查方法: 需要确认指定的用户存在于通讯录中
	ErrCode46004 ErrCode = 46004
	...
	//
	ErrCode50001 ErrCode = 50001
	// ErrCode50002 成员不在权限范围
	//
	// 排查方法: 请检查应用或管理组的权限范围
	ErrCode50002 ErrCode = 50002
	// ErrCode50003 应用已禁用
	//
	...
	//
	ErrCode50003 ErrCode = 50003
	// ErrCode60001 部门长度不符合限制
	//
	// 排查方法: 部门名称不能为空且长度不能超过32个字
	ErrCode60001 ErrCode = 60001
	// ErrCode60003 部门ID不存在
	//
	// 排查方法: 需要确认部门ID是否有带，并且存在通讯录中
	ErrCode60003 ErrCode = 60003
	// ErrCode60004 父部门不存在
	//
	// 排查方法: 需要确认父亲部门ID是否有带，并且存在通讯录中
	ErrCode60004 ErrCode = 60004
	// ErrCode60005 部门下存在成员
	//
	// 排查方法: 不允许删除有成员的部门
	ErrCode60005 ErrCode = 60005
	// ErrCode60006 部门下存在子部门
	//
	// 排查方法: 不允许删除有子部门的部门
	ErrCode60006 ErrCode = 60006
	// ErrCode60007 不允许删除根部门
	//
	// 排查方法: -
	ErrCode60007 ErrCode = 60007
	// ErrCode60008 部门已存在
	//
	// 排查方法: 部门ID或者部门名称已存在
	ErrCode60008 ErrCode = 60008
	// ErrCode60009 部门名称含有非法字符
	//
	// 排查方法: 不能含有 \:?*“<>| 等字符
	ErrCode60009 ErrCode = 60009
	...
	//
	//
	ErrCode60011 ErrCode = 60011
	// ErrCode60012 不允许删除默认应用
	//
	// 排查方法: 默认应用的id为0
	ErrCode60012 ErrCode = 60012
	...
	ErrCode80001 ErrCode = 80001
	// ErrCode81001 部门下的结点数超过限制（3W）
	//
	// 排查方法: -
	ErrCode81001 ErrCode = 81001
	// ErrCode81002 部门最多15层
	//
	// 排查方法: -
	ErrCode81002 ErrCode = 81002
	// ErrCode81003 标签下节点个数超过30000个
	//
	// 排查方法: -
	ErrCode81003 ErrCode = 81003
	...
	//
	ErrCode81011 ErrCode = 81011
	// ErrCode81012 缺失可见范围
	//
	// 排查方法: 请求没有填写UserID、部门ID、标签ID
	ErrCode81012 ErrCode = 81012
	...
	// 1）注册流程未完成。
	// 2）注册成功已超过24小时。
	ErrCode84024 ErrCode = 84024
	// ErrCode84025 不符合的state参数
	//
	// 排查方法: 必须是[a-zA-Z0-9]的参数值，长度不可超过128个字节
	ErrCode84025 ErrCode = 84025
	// ErrCode84052 缺少caller参数
	//
	// 排查方法: -
	ErrCode84052 ErrCode = 84052
	// ErrCode84053 缺少callee参数
	//
	// 排查方法: -
	ErrCode84053 ErrCode = 84053
	// ErrCode84054 缺少auth_corpid参数
	//
	// 排查方法: -
	ErrCode84054 ErrCode = 84054
	// ErrCode84055 超过拨打公费电话频率
	//
	// 排查方法: 同一个客服5秒内只能调用api拨打一次公费电话
	ErrCode84055 ErrCode = 84055
	// ErrCode84056 被拨打用户安装应用时未授权拨打公费电话权限
	//
	// 排查方法: -
	ErrCode84056 ErrCode = 84056
	// ErrCode84057 公费电话余额不足
	//
	// 排查方法: -
	ErrCode84057 ErrCode = 84057
	// ErrCode84058 caller 呼叫号码不支持
	//
	// 排查方法: -
	ErrCode84058 ErrCode = 84058
	// ErrCode84059 号码非法
	//
	// 排查方法: -
	ErrCode84059 ErrCode = 84059
	// ErrCode84060 callee 呼叫号码不支持
	//
	// 排查方法: -
	ErrCode84060 ErrCode = 84060
	// ErrCode84061 不存在外部联系人的关系
	//
	// 排查方法: -
	ErrCode84061 ErrCode = 84061
	// ErrCode84062 未开启公费电话应用
	//
	// 排查方法: -
	ErrCode84062 ErrCode = 84062
	// ErrCode84063 caller不存在
	//
	// 排查方法: -
	ErrCode84063 ErrCode = 84063
	// ErrCode84064 callee不存在
	//
	// 排查方法: -
	ErrCode84064 ErrCode = 84064
	// ErrCode84065 caller跟callee电话号码一致
	//
	// 排查方法: 不允许自己拨打给自己
	ErrCode84065 ErrCode = 84065
	// ErrCode84066 服务商拨打次数超过限制
	//
	// 排查方法: 单个企业管理员，在一天（以上午10:00为起始时间）内，对应单个服务商，只能被呼叫【4】次。
	ErrCode84066 ErrCode = 84066
	// ErrCode84067 管理员收到的服务商公费电话个数超过限制
	//
	// 排查方法: 单个企业管理员，在一天（以上午10:00为起始时间）内，一共只能被【3】个服务商成功呼叫。
	ErrCode84067 ErrCode = 84067
	// ErrCode84069 拨打方被限制拨打公费电话
	//
	// 排查方法: -
	ErrCode84069 ErrCode = 84069
	// ErrCode84070 不支持的电话号码
	//
	// 排查方法: 拨打方或者被拨打方电话号码不支持
	ErrCode84070 ErrCode = 84070
	// ErrCode84071 不合法的外部联系人授权码
	//
	// 排查方法: 非法或者已经消费过
	ErrCode84071 ErrCode = 84071
	// ErrCode84072 应用未配置客服
	//
	// 排查方法: -
	ErrCode84072 ErrCode = 84072
	// ErrCode84073 客服userid不在应用配置的客服列表中
	//
	// 排查方法: -
	ErrCode84073 ErrCode = 84073
	// ErrCode84074 没有外部联系人权限
	//
	// 排查方法: -
	ErrCode84074 ErrCode = 84074
	// ErrCode84075 不合法或过期的authcode
	//
	// 排查方法: -
	ErrCode84075 ErrCode = 84075
	// ErrCode84076 缺失authcode
	//
	// 排查方法: -
	ErrCode84076 ErrCode = 84076
	// ErrCode84077 订单价格过高，无法受理
	//
	// 排查方法: -
	ErrCode84077 ErrCode = 84077
	// ErrCode84078 购买人数不正确
	//
	// 排查方法: -
	ErrCode84078 ErrCode = 84078
	// ErrCode84079 价格策略不存在
	//
	// 排查方法: -
	ErrCode84079 ErrCode = 84079
	// ErrCode84080 订单不存在
	//
	// 排查方法: -
	ErrCode84080 ErrCode = 84080
	// ErrCode84081 存在未支付订单
	//
	// 排查方法: -
	ErrCode84081 ErrCode = 84081
	// ErrCode84082 存在申请退款中的订单
	//
	// 排查方法: -
	ErrCode84082 ErrCode = 84082
	// ErrCode84083 非服务人员
	//
	// 排查方法: -
	ErrCode84083 ErrCode = 84083
	// ErrCode84084 非跟进用户
	//
	// 排查方法: -
	ErrCode84084 ErrCode = 84084
	// ErrCode84085 应用已下架
	//
	// 排查方法: -
	ErrCode84085 ErrCode = 84085
	// ErrCode84086 订单人数超过可购买最大人数
	//
	// 排查方法: -
	ErrCode84086 ErrCode = 84086
	// ErrCode84087 打开订单支付前禁止关闭订单
	//
	// 排查方法: -
	ErrCode84087 ErrCode = 84087
	// ErrCode84088 禁止关闭已支付的订单
	//
	// 排查方法: -
	ErrCode84088 ErrCode = 84088
	// ErrCode84089 订单已支付
	//
	// 排查方法: -
	ErrCode84089 ErrCode = 84089
	// ErrCode84090 缺失user_ticket
	//
	// 排查方法: -
	ErrCode84090 ErrCode = 84090
	// ErrCode84091 订单价格不可低于下限
	//
	// 排查方法: -
	ErrCode84091 ErrCode = 84091
	// ErrCode84092 无法发起代下单操作
	//
	// 排查方法: -
	ErrCode84092 ErrCode = 84092
	// ErrCode84093 代理关系已占用，无法代下单
	//
	// 排查方法: -
	ErrCode84093 ErrCode = 84093
	// ErrCode84094 该应用未配置代理分润规则，请先联系应用服务商处理
	//
	// 排查方法: -
	ErrCode84094 ErrCode = 84094
	// ErrCode84095 免费试用版，无法扩容
	//
	// 排查方法: -
	ErrCode84095 ErrCode = 84095
	// ErrCode84096 免费试用版，无法续期
	//
	// 排查方法: -
	ErrCode84096 ErrCode = 84096
	// ErrCode84097 当前企业有未处理订单
	//
	// 排查方法: -
	ErrCode84097 ErrCode = 84097
	// ErrCode84098 固定总量，无法扩容
	//
	// 排查方法: -
	ErrCode84098 ErrCode = 84098
	// ErrCode84099 非购买状态，无法扩容
	//
	// 排查方法: -
	ErrCode84099 ErrCode = 84099
	// ErrCode84100 未购买过此应用，无法续期
	//
	// 排查方法: -
	ErrCode84100 ErrCode = 84100
	// ErrCode84101 企业已试用付费版本，无法全新购买
	//
	// 排查方法: -
	ErrCode84101 ErrCode = 84101
	// ErrCode84102 企业当前应用状态已过期，无法扩容
	//
	// 排查方法: -
	ErrCode84102 ErrCode = 84102
	// ErrCode84103 仅可修改未支付订单
	//
	// 排查方法: -
	ErrCode84103 ErrCode = 84103
	// ErrCode84104 订单已支付，无法修改
	//
	// 排查方法: -
	ErrCode84104 ErrCode = 84104
	// ErrCode84105 订单已被取消，无法修改
	//
	// 排查方法: -
	ErrCode84105 ErrCode = 84105
	// ErrCode84106 企业含有该应用的待支付订单，无法代下单
	//
	// 排查方法: -
	ErrCode84106 ErrCode = 84106
	// ErrCode84107 企业含有该应用的退款中订单，无法代下单
	//
	// 排查方法: -
	ErrCode84107 ErrCode = 84107
	// ErrCode84108 企业含有该应用的待生效订单，无法代下单
	//
	// 排查方法: -
	ErrCode84108 ErrCode = 84108
	// ErrCode84109 订单定价不能未0
	//
	// 排查方法: -
	ErrCode84109 ErrCode = 84109
	// ErrCode84110 新安装应用不在试用状态，无法升级为付费版
	//
	// 排查方法: -
	ErrCode84110 ErrCode = 84110
	// ErrCode84111 无足够可用优惠券
	//
	// 排查方法: -
	ErrCode84111 ErrCode = 84111
	// ErrCode84112 无法关闭未支付订单
	//
	// 排查方法: -
	ErrCode84112 ErrCode = 84112
	// ErrCode84113 无付费信息
	//
	// 排查方法: -
	ErrCode84113 ErrCode = 84113
	// ErrCode84114 虚拟版本不支持下单
	//
	// 排查方法: -
	ErrCode84114 ErrCode = 84114
	// ErrCode84115 虚拟版本不支持扩容
	//
	// 排查方法: -
	ErrCode84115 ErrCode = 84115
	// ErrCode84116 虚拟版本不支持续期
	//
	// 排查方法: -
	ErrCode84116 ErrCode = 84116
	// ErrCode84117 在虚拟正式版期内不能扩容
	//
	// 排查方法: -
	ErrCode84117 ErrCode = 84117
	// ErrCode84118 虚拟正式版期内不能变更版本
	//
	// 排查方法: -
	ErrCode84118 ErrCode = 84118
	// ErrCode84119 当前企业未报备，无法进行代下单
	//
	// 排查方法: -
	ErrCode84119 ErrCode = 84119
	// ErrCode84120 当前应用版本已删除
	//
	// 排查方法: -
	ErrCode84120 ErrCode = 84120
	// ErrCode84121 应用版本已删除，无法扩容
	//
	// 排查方法: -
	ErrCode84121 ErrCode = 84121
	// ErrCode84122 应用版本已删除，无法续期
	//
	// 排查方法: -
	ErrCode84122 ErrCode = 84122
	// ErrCode84123 非虚拟版本，无法升级
	//
	// 排查方法: -
	ErrCode84123 ErrCode = 84123
	// ErrCode84124 非行业方案订单，不能添加部分应用版本的订单
	//
	// 排查方法: -
	ErrCode84124 ErrCode = 84124
	// ErrCode84125 购买人数不能少于最少购买人数
	//
	// 排查方法: -
	ErrCode84125 ErrCode = 84125
	// ErrCode84126 购买人数不能多于最大购买人数
	//
	// 排查方法: -
	ErrCode84126 ErrCode = 84126
	// ErrCode84127 无应用管理权限
	//
	// 排查方法: -
	ErrCode84127 ErrCode = 84127
	// ErrCode84128 无该行业方案下全部应用的管理权限
	//
	// 排查方法: -
	ErrCode84128 ErrCode = 84128
	// ErrCode84129 付费策略已被删除，无法下单
	//
	// 排查方法: -
	ErrCode84129 ErrCode = 84129
	// ErrCode84130 订单生效时间不合法
	//
	// 排查方法: -
	ErrCode84130 ErrCode = 84130
	// ErrCode84200 文件转译解析错误
	//
	// 排查方法: 只支持utf8文件转译，可能是不支持的文件类型或者格式
	ErrCode84200 ErrCode = 84200
	// ErrCode85002 包含不合法的词语
	//
	// 排查方法: -
	ErrCode85002 ErrCode = 85002
	// ErrCode85004 每企业每个月设置的可信域名不可超过20个
	//
	// 排查方法: -
	ErrCode85004 ErrCode = 85004
	...
	ErrCode85005 ErrCode = 85005
	// ErrCode86001 参数 chatid 不合法
	//
	// 排查方法: -
	ErrCode86001 ErrCode = 86001
	// ErrCode86003 参数 chatid 不存在
	//
	// 排查方法: -
	ErrCode86003 ErrCode = 86003
	// ErrCode86004 参数 群名不合法
	//
	// 排查方法: -
	ErrCode86004 ErrCode = 86004
	// ErrCode86005 参数 群主不合法
	//
	// 排查方法: -
	ErrCode86005 ErrCode = 86005
	// ErrCode86006 群成员数过多或过少
	//
	// 排查方法: -
	ErrCode86006 ErrCode = 86006
	// ErrCode86007 不合法的群成员
	//
	// 排查方法: -
	ErrCode86007 ErrCode = 86007
	// ErrCode86008 非法操作非自己创建的群
	//
	// 排查方法: -
	ErrCode86008 ErrCode = 86008
	// ErrCode86101 仅群主才有操作权限
	//
	// 排查方法: -
	ErrCode86101 ErrCode = 86101
	// ErrCode86201 参数 需要chatid
	//
	// 排查方法: -
	ErrCode86201 ErrCode = 86201
	// ErrCode86202 参数 需要群名
	//
	// 排查方法: -
	ErrCode86202 ErrCode = 86202
	// ErrCode86203 参数 需要群主
	//
	// 排查方法: -
	ErrCode86203 ErrCode = 86203
	// ErrCode86204 参数 需要群成员
	//
	// 排查方法: -
	ErrCode86204 ErrCode = 86204
	// ErrCode86205 参数 字符串chatid过长
	//
	// 排查方法: -
	ErrCode86205 ErrCode = 86205
	// ErrCode86206 参数 数字chatid过大
	//
	// 排查方法: -
	ErrCode86206 ErrCode = 86206
	// ErrCode86207 群主不在群成员列表
	//
	// 排查方法: -
	ErrCode86207 ErrCode = 86207
	// ErrCode86215 会话ID已经存在
	//
	// 排查方法: -
	ErrCode86215 ErrCode = 86215
	...
	ErrCode86216 ErrCode = 86216
	// ErrCode86217 会话发送者不在会话成员列表中
	//
	// 排查方法: 会话的发送者，必须是会话的成员列表之一
	ErrCode86217 ErrCode = 86217
	...
	ErrCode86220 ErrCode = 86220
	// ErrCode86224 不是受限群，不允许使用该接口
	//
	// 排查方法: -
	ErrCode86224 ErrCode = 86224
	// ErrCode90001 未认证摇一摇周边
	//
	// 排查方法: -
	ErrCode90001 ErrCode = 90001
	// ErrCode90002 缺少摇一摇周边ticket参数
	//
	// 排查方法: -
	ErrCode90002 ErrCode = 90002
	// ErrCode90003 摇一摇周边ticket参数不合法
	//
	// 排查方法: -
	ErrCode90003 ErrCode = 90003
	// ErrCode90100 非法的对外属性类型
	//
	// 排查方法: -
	ErrCode90100 ErrCode = 90100
	// ErrCode90101 对外属性：文本类型长度不合法
	//
	// 排查方法: 文本长度不可超过12个UTF8字符
	ErrCode90101 ErrCode = 90101
	// ErrCode90102 对外属性：网页类型标题长度不合法
	//
	// 排查方法: 标题长度不可超过12个UTF8字符
	ErrCode90102 ErrCode = 90102
	// ErrCode90103 对外属性：网页url不合法
	//
	// 排查方法: -
	ErrCode90103 ErrCode = 90103
	// ErrCode90104 对外属性：小程序类型标题长度不合法
	//
	// 排查方法: 标题长度不可超过12个UTF8字符
	ErrCode90104 ErrCode = 90104
	// ErrCode90105 对外属性：小程序类型pagepath不合法
	//
	// 排查方法: -
	ErrCode90105 ErrCode = 90105
	// ErrCode90106 对外属性：请求参数不合法
	//
	// 排查方法: -
	ErrCode90106 ErrCode = 90106
	// ErrCode90200 缺少小程序appid参数
	//
	// 排查方法: -
	ErrCode90200 ErrCode = 90200
	// ErrCode90201 小程序通知的content_item个数超过限制
	//
	// 排查方法: item个数不能超过10个
	ErrCode90201 ErrCode = 90201
	// ErrCode90202 小程序通知中的key长度不合法
	//
	// 排查方法: 不能为空或超过10个汉字
	ErrCode90202 ErrCode = 90202
	// ErrCode90203 小程序通知中的value长度不合法
	//
	// 排查方法: 不能为空或超过30个汉字
	ErrCode90203 ErrCode = 90203
	// ErrCode90204 小程序通知中的page参数不合法
	//
	// 排查方法: -
	ErrCode90204 ErrCode = 90204
	// ErrCode90206 小程序未关联到企业中
	//
	// 排查方法: -
	ErrCode90206 ErrCode = 90206
	// ErrCode90207 不合法的小程序appid
	//
	// 排查方法: -
	ErrCode90207 ErrCode = 90207
	// ErrCode90208 小程序appid不匹配
	//
	// 排查方法: -
	ErrCode90208 ErrCode = 90208
	// ErrCode90300 orderid 不合法
	//
	// 排查方法: -
	ErrCode90300 ErrCode = 90300
	// ErrCode90302 付费应用已过期
	//
	// 排查方法: -
	ErrCode90302 ErrCode = 90302
	// ErrCode90303 付费应用超过最大使用人数
	//
	// 排查方法: -
	ErrCode90303 ErrCode = 90303
	// ErrCode90304 订单中心服务异常，请稍后重试
	//
	// 排查方法: -
	ErrCode90304 ErrCode = 90304
	// ErrCode90305 参数错误，errmsg中有提示具体哪个参数有问题
	//
	// 排查方法: -
	ErrCode90305 ErrCode = 90305
	// ErrCode90306 商户设置不合法，详情请见errmsg
	//
	// 排查方法: -
	ErrCode90306 ErrCode = 90306
	// ErrCode90307 登录态过期
	//
	// 排查方法: -
	ErrCode90307 ErrCode = 90307
	// ErrCode90308 在开启IP鉴权的前提下，识别为无效的请求IP
	//
	// 排查方法: -
	ErrCode90308 ErrCode = 90308
	// ErrCode90309 订单已经存在，请勿重复下单
	//
	// 排查方法: -
	ErrCode90309 ErrCode = 90309
	// ErrCode90310 找不到订单
	//
	// 排查方法: -
	ErrCode90310 ErrCode = 90310
	// ErrCode90311 关单失败, 可能原因：该单并没被拉起支付页面; 已经关单；已经支付；渠道失败；单处于保护状态；等等
	//
	// 排查方法: -
	ErrCode90311 ErrCode = 90311
	// ErrCode90312 退款请求失败, 详情请看errmsg
	//
	// 排查方法: -
	ErrCode90312 ErrCode = 90312
	// ErrCode90313 退款调用频率限制，超过规定的阈值
	//
	// 排查方法: -
	ErrCode90313 ErrCode = 90313
	// ErrCode90314 订单状态错误，可能未支付，或者当前状态操作受限
	//
	// 排查方法: -
	ErrCode90314 ErrCode = 90314
	// ErrCode90315 退款请求失败，主键冲突，请核实退款refund_id是否已使用
	//
	// 排查方法: -
	ErrCode90315 ErrCode = 90315
	// ErrCode90316 退款原因编号不对
	//
	// 排查方法: -
	ErrCode90316 ErrCode = 90316
	// ErrCode90317 尚未注册成为供应商
	//
	// 排查方法: -
	ErrCode90317 ErrCode = 90317
	// ErrCode90318 参数nonce_str 为空或者重复，判定为重放攻击
	//
	// 排查方法: -
	ErrCode90318 ErrCode = 90318
	// ErrCode90319 时间戳为空或者与系统时间间隔太大
	//
	// 排查方法: -
	ErrCode90319 ErrCode = 90319
	// ErrCode90320 订单token无效
	//
	// 排查方法: -
	ErrCode90320 ErrCode = 90320
	// ErrCode90321 订单token已过有效时间
	//
	// 排查方法: -
	ErrCode90321 ErrCode = 90321
	// ErrCode90322 旧套件（包含多个应用的套件）不支持支付系统
	//
	// 排查方法: -
	ErrCode90322 ErrCode = 90322
	// ErrCode90323 单价超过限额
	//
	// 排查方法: -
	ErrCode90323 ErrCode = 90323
	// ErrCode90324 商品数量超过限额
	//
	// 排查方法: -
	ErrCode90324 ErrCode = 90324
	// ErrCode90325 预支单已经存在
	//
	// 排查方法: -
	ErrCode90325 ErrCode = 90325
	// ErrCode90326 预支单单号非法
	//
	// 排查方法: -
	ErrCode90326 ErrCode = 90326
	// ErrCode90327 该预支单已经结算下单
	//
	// 排查方法: -
	ErrCode90327 ErrCode = 90327
	// ErrCode90328 结算下单失败，详情请看errmsg
	//
	// 排查方法: -
	ErrCode90328 ErrCode = 90328
	// ErrCode90329 该订单号已经被预支单占用
	//
	// 排查方法: -
	ErrCode90329 ErrCode = 90329
	// ErrCode90330 创建供应商失败
	//
	// 排查方法: -
	ErrCode90330 ErrCode = 90330
	// ErrCode90331 更新供应商失败
	//
	// 排查方法: -
	ErrCode90331 ErrCode = 90331
	// ErrCode90332 还没签署合同
	//
	// 排查方法: -
	ErrCode90332 ErrCode = 90332
	// ErrCode90333 创建合同失败
	//
	// 排查方法: -
	ErrCode90333 ErrCode = 90333
	// ErrCode90338 已经过了可退款期限
	//
	// 排查方法: -
	ErrCode90338 ErrCode = 90338
	// ErrCode90339 供应商主体名包含非法字符
	//
	// 排查方法: -
	ErrCode90339 ErrCode = 90339
	// ErrCode90340 创建客户失败，可能信息真实性校验失败
	//
	// 排查方法: -
	ErrCode90340 ErrCode = 90340
	// ErrCode90341 退款金额大于付款金额
	//
	// 排查方法: -
	ErrCode90341 ErrCode = 90341
	// ErrCode90342 退款金额超过账户余额
	//
	// 排查方法: -
	ErrCode90342 ErrCode = 90342
	// ErrCode90343 退款单号已经存在
	//
	// 排查方法: -
	ErrCode90343 ErrCode = 90343
	// ErrCode90344 指定的付款渠道无效
	//
	// 排查方法: -
	ErrCode90344 ErrCode = 90344
	// ErrCode90345 超过5w人民币不可指定微信支付渠道
	//
	// 排查方法: -
	ErrCode90345 ErrCode = 90345
	// ErrCode90346 同一单的退款次数超过限制
	//
	// 排查方法: -
	ErrCode90346 ErrCode = 90346
	// ErrCode90347 退款金额不可为0
	//
	// 排查方法: -
	ErrCode90347 ErrCode = 90347
	// ErrCode90348 管理端没配置支付密钥
	//
	// 排查方法: -
	ErrCode90348 ErrCode = 90348
	// ErrCode90349 记录数量太大
	//
	// 排查方法: -
	ErrCode90349 ErrCode = 90349
	// ErrCode90350 银行信息真实性校验失败
	//
	// 排查方法: -
	ErrCode90350 ErrCode = 90350
	// ErrCode90351 应用状态异常
	//
	// 排查方法: -
	ErrCode90351 ErrCode = 90351
	// ErrCode90352 延迟试用期天数超过限制
	//
	// 排查方法: -
	ErrCode90352 ErrCode = 90352
	// ErrCode90353 预支单列表不可为空
	//
	// 排查方法: -
	ErrCode90353 ErrCode = 90353
	// ErrCode90354 预支单列表数量超过限制
	//
	// 排查方法: -
	ErrCode90354 ErrCode = 90354
	// ErrCode90355 关联有退款预支单，不可删除
	//
	// 排查方法: -
	ErrCode90355 ErrCode = 90355
	// ErrCode90356 不能0金额下单
	//
	// 排查方法: -
	ErrCode90356 ErrCode = 90356
	// ErrCode90357 代下单必须指定支付渠道
	//
	// 排查方法: -
	ErrCode90357 ErrCode = 90357
	// ErrCode90358 预支单或代下单，不支持部分退款
	//
	// 排查方法: -
	ErrCode90358 ErrCode = 90358
	// ErrCode90456 必须指定组织者
	//
	// 排查方法: -
	ErrCode90456 ErrCode = 90456
	// ErrCode90457 日历ID异常
	//
	// 排查方法: -
	ErrCode90457 ErrCode = 90457
	// ErrCode90458 日历ID列表不能为空
	//
	// 排查方法: -
	ErrCode90458 ErrCode = 90458
	// ErrCode90459 日历已删除
	//
	// 排查方法: -
	ErrCode90459 ErrCode = 90459
	// ErrCode90460 日程已删除
	//
	// 排查方法: -
	ErrCode90460 ErrCode = 90460
	// ErrCode90461 日程ID异常
	//
	// 排查方法: -
	ErrCode90461 ErrCode = 90461
	// ErrCode90462 日程ID列表不能为空
	//
	// 排查方法: -
	ErrCode90462 ErrCode = 90462
	// ErrCode90463 不能变更组织者
	//
	// 排查方法: -
	ErrCode90463 ErrCode = 90463
	// ErrCode90464 参与者数量超过限制
	//
	// 排查方法: -
	ErrCode90464 ErrCode = 90464
	// ErrCode90465 不支持的重复类型
	//
	// 排查方法: -
	ErrCode90465 ErrCode = 90465
	// ErrCode90466 不能操作别的应用创建的日历/日程
	//
	// 排查方法: -
	ErrCode90466 ErrCode = 90466
	// ErrCode90467 星期参数异常
	//
	// 排查方法: -
	ErrCode90467 ErrCode = 90467
	// ErrCode90468 不能变更组织者
	//
	// 排查方法: -
	ErrCode90468 ErrCode = 90468
	// ErrCode90469 每页大小超过限制
	//
	// 排查方法: -
	ErrCode90469 ErrCode = 90469
	// ErrCode90470 页数异常
	//
	// 排查方法: -
	ErrCode90470 ErrCode = 90470
	// ErrCode90471 提醒时间异常
	//
	// 排查方法: -
	ErrCode90471 ErrCode = 90471
	// ErrCode90472 没有日历/日程操作权限
	//
	// 排查方法: -
	ErrCode90472 ErrCode = 90472
	// ErrCode90473 颜色参数异常
	//
	// 排查方法: -
	ErrCode90473 ErrCode = 90473
	// ErrCode90474 组织者不能与参与者重叠
	//
	// 排查方法: -
	ErrCode90474 ErrCode = 90474
	// ErrCode90475 不是组织者的日历
	//
	// 排查方法: -
	ErrCode90475 ErrCode = 90475
	...
	ErrCode91040 ErrCode = 91040
	// ErrCode93004 机器人被停用
	//
	// 排查方法: -
	ErrCode93004 ErrCode = 93004
	// ErrCode94000 应用未开启工作台自定义模式
	//
	// 排查方法: 请在管理端后台应用详情里面开启自定义工作台模式
	ErrCode94000 ErrCode = 94000
	// ErrCode94001 不合法的type类型
	//
	// 排查方法: -
	ErrCode94001 ErrCode = 94001
	// ErrCode94002 缺少keydata字段
	//
	// 排查方法: -
	ErrCode94002 ErrCode = 94002
	// ErrCode94003 keydata的items列表长度超出限制
	//
	// 排查方法: -
	ErrCode94003 ErrCode = 94003
	// ErrCode94005 缺少list字段
	//
	// 排查方法: -
	ErrCode94005 ErrCode = 94005
	// ErrCode94006 list的items列表长度超出限制
	//
	// 排查方法: -
	ErrCode94006 ErrCode = 94006
	// ErrCode94007 缺少webview字段
	//
	// 排查方法: -
	ErrCode94007 ErrCode = 94007
	// ErrCode94008 应用未设置自定义工作台模版类型
	//
	// 排查方法: -
	ErrCode94008 ErrCode = 94008
	...
	ErrCode301036 ErrCode = 301036
	// ErrCode302003 批量导入任务的文件中userid有重复
	//
	// 排查方法: -
	ErrCode302003 ErrCode = 302003
	// ErrCode302004 组织架构不合法（1不是一棵树，2 多个一样的partyid，3 partyid空，4 partyid name 空，5 同一个父节点下有两个子节点 部门名字一样 可能是以上情况，请一一排查）
	//
	// 排查方法: -
	ErrCode302004 ErrCode = 302004
	// ErrCode302005 批量导入系统失败，请重新尝试导入
	//
	// 排查方法: -
	ErrCode302005 ErrCode = 302005
	// ErrCode302006 批量导入任务的文件中partyid有重复
	//
	// 排查方法: -
	ErrCode302006 ErrCode = 302006
	// ErrCode302007 批量导入任务的文件中，同一个部门下有两个子部门名字一样
	//
	// 排查方法: -
	ErrCode302007 ErrCode = 302007
	// ErrCode2000002 CorpId参数无效
	//
	// 排查方法: 指定的CorpId不存在
	ErrCode2000002 ErrCode = 2000002
	// ErrCode600001 不合法的sn
	//
	// 排查方法: sn可能尚未进行登记
	ErrCode600001 ErrCode = 600001
	// ErrCode600002 设备已注册
	//
	// 排查方法: 可能设备已经建立过长连接
	ErrCode600002 ErrCode = 600002
	// ErrCode600003 不合法的硬件activecode
	//
	// 排查方法: -
	ErrCode600003 ErrCode = 600003
	// ErrCode600004 该硬件尚未授权任何企业
	//
	// 排查方法: -
	ErrCode600004 ErrCode = 600004
	// ErrCode600005 硬件Secret无效
	//
	// 排查方法: -
	ErrCode600005 ErrCode = 600005
	// ErrCode600007 缺少硬件sn
	//
	// 排查方法: -
	ErrCode600007 ErrCode = 600007
	// ErrCode600008 缺少nonce参数
	//
	// 排查方法: -
	ErrCode600008 ErrCode = 600008
	// ErrCode600009 缺少timestamp参数
	//
	// 排查方法: -
	ErrCode600009 ErrCode = 600009
	// ErrCode600010 缺少signature参数
	//
	// 排查方法: -
	ErrCode600010 ErrCode = 600010
	// ErrCode600011 签名校验失败
	//
	// 排查方法: -
	ErrCode600011 ErrCode = 600011
	// ErrCode600012 长连接已经注册过设备
	//
	// 排查方法: -
	ErrCode600012 ErrCode = 600012
	// ErrCode600013 缺少activecode参数
	//
	// 排查方法: -
	ErrCode600013 ErrCode = 600013
	// ErrCode600014 设备未网络注册
	//
	// 排查方法: -
	ErrCode600014 ErrCode = 600014
	// ErrCode600015 缺少secret参数
	//
	// 排查方法: -
	ErrCode600015 ErrCode = 600015
	// ErrCode600016 设备未激活
	//
	// 排查方法: -
	ErrCode600016 ErrCode = 600016
	// ErrCode600018 无效的起始结束时间
	//
	// 排查方法: -
	ErrCode600018 ErrCode = 600018
	// ErrCode600020 设备未登录
	//
	// 排查方法: -
	ErrCode600020 ErrCode = 600020
	// ErrCode600021 设备sn已存在
	//
	// 排查方法: -
	ErrCode600021 ErrCode = 600021
	// ErrCode600023 时间戳已失效
	//
	// 排查方法: -
	ErrCode600023 ErrCode = 600023
	// ErrCode600024 固件大小超过5M
	//
	// 排查方法: -
	ErrCode600024 ErrCode = 600024
	// ErrCode600025 固件名为空或者超过20字节
	//
	// 排查方法: -
	ErrCode600025 ErrCode = 600025
	// ErrCode600026 固件信息不存在
	//
	// 排查方法: -
	ErrCode600026 ErrCode = 600026
	// ErrCode600027 非法的固件参数
	//
	// 排查方法: -
	ErrCode600027 ErrCode = 600027
	// ErrCode600028 固件版本已存在
	//
	// 排查方法: -
	ErrCode600028 ErrCode = 600028
	// ErrCode600029 非法的固件版本
	//
	// 排查方法: -
	ErrCode600029 ErrCode = 600029
	// ErrCode600030 缺少固件版本参数
	//
	// 排查方法: -
	ErrCode600030 ErrCode = 600030
	// ErrCode600031 硬件固件不允许升级
	//
	// 排查方法: -
	ErrCode600031 ErrCode = 600031
	// ErrCode600032 无法解析硬件二维码
	//
	// 排查方法: -
	ErrCode600032 ErrCode = 600032
	// ErrCode600033 设备型号id冲突
	//
	// 排查方法: -
	ErrCode600033 ErrCode = 600033
	// ErrCode600034 指纹数据大小超过限制
	//
	// 排查方法: -
	ErrCode600034 ErrCode = 600034
	// ErrCode600035 人脸数据大小超过限制
	//
	// 排查方法: -
	ErrCode600035 ErrCode = 600035
	// ErrCode600036 设备sn冲突
	//
	// 排查方法: -
	ErrCode600036 ErrCode = 600036
	// ErrCode600037 缺失设备型号id
	//
	// 排查方法: -
	ErrCode600037 ErrCode = 600037
	// ErrCode600038 设备型号不存在
	//
	// 排查方法: -
	ErrCode600038 ErrCode = 600038
	// ErrCode600039 不支持的设备类型
	//
	// 排查方法: -
	ErrCode600039 ErrCode = 600039
	// ErrCode600040 打印任务id不存在
	//
	// 排查方法: -
	ErrCode600040 ErrCode = 600040
	// ErrCode600041 无效的offset或limit参数值
	//
	// 排查方法: -
	ErrCode600041 ErrCode = 600041
	// ErrCode600042 无效的设备型号id
	//
	// 排查方法: -
	ErrCode600042 ErrCode = 600042
	// ErrCode600043 门禁规则未设置
	//
	// 排查方法: -
	ErrCode600043 ErrCode = 600043
	// ErrCode600044 门禁规则不合法
	//
	// 排查方法: -
	ErrCode600044 ErrCode = 600044
	// ErrCode600045 设备已订阅企业信息
	//
	// 排查方法: -
	ErrCode600045 ErrCode = 600045
	// ErrCode610001 永久二维码超过每个员工5000的限制
	//
	// 排查方法: -
	ErrCode610001 ErrCode = 610001
	// ErrCode610003 scene参数不合法
	//
	// 排查方法: 有效的scene长度为1~64字符，由英文字母、数字、中划线、下划线以及点号构成
	ErrCode610003 ErrCode = 610003
	// ErrCode610004 userid不在客户联系配置的使用范围内
	//
	// 排查方法: 请在管理端后台 客户联系->配置->配置使用范围配置该用户
	ErrCode610004 ErrCode = 610004
)
